...
SphereRigidbody::SphereRigidbody (GameObject *gameObject, float radius, float mass, int col_mask, int col_to_masks,
	 btRigidBody::btRigidBodyConstructionInfo* _rigid_info) : Rigidbody(gameObject) 
{
